...
namespace Spark {
	...
	public:
		...
		inline void SetViewportSize(float width, float height) { m_ViewportWitdh = width; m_ViewportHeight = height; UpdateProjection(); }
	...
	private:
		...
		float m_ViewportWitdh = 1280, m_ViewportHeight = 720;
	};
